---
title: "Phase 3: DRY PEAS Agricultural Commodity Loss Variations across the Pacific Northwest Palouse Region, 1989-2015 - Mixed Modeling Analysis"
author: "Erich Seamon"
date: "9/25/2018"
output:
...
In Phase 3, we perform a DRY PEAS mixed modeling analysis using a two-step hurdle technique for a selected set of damage causes.  The following analysis builds on Phases 1 and 2, steps 1-10.

**Step 11.** DRY PEAS Commodity Mixed Model Analysis.  In Step 11, we perform a DRY PEAS mixed modeling analysis, using a two step hurdle model technique to address zero-inflated data.
