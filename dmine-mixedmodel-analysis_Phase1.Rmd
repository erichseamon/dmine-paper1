...
##Step 3: Entire PNW Overview of Insurance Loss: 1989-2015
...
barplot(YYY1$loss, names.arg = YYY1$year, las = 3, yaxt="n", ylab = "Loss ($)", main = "PNW total insurance Loss by Year: 2001 - 2015", col = "lightblue", xlab = "Year") 
