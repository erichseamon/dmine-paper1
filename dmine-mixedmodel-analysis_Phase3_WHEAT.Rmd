...
In Phase 3, we perform WHEAT mixed modeling analysis using a two-step hurdle technique for a selected set of damage causes.  The following analysis builds on Phases 1 and 2, steps 1-10.

**Step 10.** WHEAT Commodity Mixed Model Analysis.  In Step 11, we perform a WHEAT mixed modeling analysis, using a two step hurdle model technique to address zero-inflated data.
