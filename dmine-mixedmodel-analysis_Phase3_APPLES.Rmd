---
title: "Phase 3: APPLES Agricultural Commodity Loss Variations across the Pacific Northwest Palouse Region, 1989-2015 - Mixed Modeling Analysis"
author: "Erich Seamon"
date: "9/25/2018"
output:
...
non_zero = apples claims by county and year, with zero claims per county/year excluded
...
chisq.test(alllevs2_apples$non_zero, fitted(m1))
...
alllevs2_apples$damagecause = factor(alllevs2_apples$damagecause,levels(alllevs2_apples$damagecause)[c(6,1:5)])
...
###We examine the APPLES model coefficent estimates of our model output.
...
colnames(coef_apples_exp) <- c("factors", "lower", "upper", "odds_ratio", "stderror")
coef_apples_exp
...
ggplot(coef_apples_exp, aes(x = factors, y = odds_ratio)) +
