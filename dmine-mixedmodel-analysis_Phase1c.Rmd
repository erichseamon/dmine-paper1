...
#rmarkdown::render(input = "/dmine/code/git/dmine-paper1/dmine-mixedmodel-analysis_Phase1a.Rmd", output_file = paste("/tmp/dmine-mixedmodel-analysis_Phase1a.html", sep=""))

```
##AJAE Appendix for “Agricultural Insurance Analysis of the Pacific Northwest, 2001-2015”

###Erich Seamon, Paul E. Gessler, John T. Abatzoglou, Philip Mote, Stephen Lee
...
#save(RMA_1989,file="/dmine/code/git/paper-PHD1/data/RMA_Rda/RMA_US_1989_2000.Rda")
...
#save(RMA_2001_2015,file="/dmine/code/git/paper-PHD1/data/RMA_Rda/RMA_US_2001_2015.Rda")


RMA_PNW <- subset(RMA, state == "WA" | state == "OR" | state == "ID" )
RMA_PNW_2001_2015 <-RMA_PNW
#write.csv(RMA_PNW, file = "/dmine/code/git/paper-PHD1/data/RMA_aggregatedcsv/PNW_RMA_2001_2015.csv")
#save(RMA_PNW_2001_2015,file="/dmine/code/git/paper-PHD1/data/RMA_Rda/RMA_PNW_2001_2015.Rda")

RMA_PNW_1989 <- subset(RMA_1989, state == "WA" | state == "OR" | state == "ID" )
#save(RMA_PNW_1989,file="/dmine/code/git/paper-PHD1/data/RMA_Rda/RMA_PNW_1989_2000.Rda")
...
#-loads RMA_US_2001_2015 data frame from github

download.file("https://github.com/erichseamon/paper-PHD1/blob/master/data/RMA_Rda/RMA_US_1989_2000.Rda?raw=true", 
    destfile = "/tmp/RMA_US_1989_2000.rda", method = "wget")

#-loads RMA_US_2001_2015 data frame from github
load("/tmp/RMA_US_1989_2000.rda")


#-loads RMA_US_1989_2000 data frame from github

download.file("https://github.com/erichseamon/paper-PHD1/blob/master/data/RMA_Rda/RMA_US_2001_2015.Rda?raw=true", 
    destfile = "/tmp/RMA_US_2001_2015.rda", method = "wget")

#-loads RMA_US_2001_2015 data frame from github
load("/tmp/RMA_US_2001_2015.rda")


#-loads RMA_PNW_2001_2015 data frame from github

download.file("https://github.com/erichseamon/paper-PHD1/blob/master/data/RMA_Rda/RMA_PNW_2001_2015.Rda?raw=true", 
    destfile = "/tmp/RMA_PNW_2001_2015.rda", method = "wget")

#-loads RMA_PNW_2001_2015 data frame from github
load("/tmp/RMA_PNW_2001_2015.rda")

#-loads RMA_PNW_2001_2015 data frame from github

download.file("https://github.com/erichseamon/paper-PHD1/blob/master/data/RMA_Rda/RMA_PNW_1989_2000.Rda?raw=true", 
    destfile = "/tmp/RMA_PNW_1989_2000.rda", method = "wget")

#-loads RMA_PNW_2001_2015 data frame from github
load("/tmp/RMA_PNW_1989_2000.rda")


RMA_PNW_2001_2015$lossperacre <- RMA_PNW_2001_2015$loss / RMA_PNW$acres

RMA_PNW_2001_2015 <- subset(RMA_PNW_2001_2015, month != "")

RMA_PNW_2001_2015$cropyear <- RMA_PNW_2001_2015$year

RMA_PNW_2001_2015$cropyear[RMA_PNW_2001_2015$monthcode >= 10] <- RMA_PNW_2001_2015$year + 1

RMA_PNW_2001_2015 <- subset(RMA_PNW_2001_2015, year != 2016)
...
library(stringi)
RMA_PNW_2001_2015_1 <- RMA_PNW_2001_2015[-8]
RMA_PNW_2001_2015_1 <- RMA_PNW_2001_2015_1[-9]
RMA_PNW_2001_2015_1 <- RMA_PNW_2001_2015_1[-9]

RMA_PNW_1989_2015 <- rbind(RMA_PNW_1989_2000, RMA_PNW_2001_2015_1)
palouse_sumloss_1989_2015 <- aggregate(RMA_PNW_1989_2015$loss, list(RMA_PNW_1989_2015$year), FUN = "sum")
...
ggplot(palouse_sumloss_1989_2015_loss_barplot, aes(fill=region, y=loss, x=commodity)) + 
    geom_bar( stat="identity") + theme_bw() + theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank()) + ggtitle("PNW vs IPNW loss vs. commodity: 2001 to 2015") + theme(axis.title.y = element_text(family = "Serif", size=18), axis.title.x = element_text(family = "Serif", size = 18), axis.text.x = element_text(size=rel(1.9), angle = 90, hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.9), hjust = 1, family = "Serif")) + theme(plot.title = element_text(family = "Serif", vjust = 2))  + theme(legend.text=element_text(family = "Serif", size=14)) + theme(legend.title=element_text(family = "Serif", size=16, face = "bold")) + theme(plot.title = element_text(size=24, face = "bold")) + scale_y_continuous(labels = paste(pts, "M", sep = ""), breaks = pts * 1000000 ) + ylab("Insurance Claim Loss ($)") + theme(legend.position="bottom") + scale_fill_discrete(name = "Legend") + scale_fill_manual("legend", values = c("IPNW" = "red", "PNW minus IPNW" = "blue"))
...
RMA_PNW_noneg <- subset(RMA_PNW_2001_2015, lossperacre != Inf)
...
pca_RMA_damage_IPNW_exogenous_factor <- prcomp(RMA_damage_IPNW_exogenous_factor, scale = TRUE, center = TRUE)

p1 <- data.frame(pca_RMA_damage_IPNW_exogenous_factor$rotation)
library(htmlTable)

htmlTable(round(p1[,1:2], 3),
          cgroup = c("2001-2015"),
          n.cgroup = c(2),
          caption = "IPNW PCA damage cause variable loadings",
          align = "c",
          rnames = rownames(p1),
          css.cell = "padding-left: .5em; padding-right: .5em;")
...
library(FactoMineR)
result <- PCA(RMA_damage_IPNW_exogenous_factor, scale.unit = TRUE, graph = T) # graphs generated automatically

res <- result$var$cor[,1:2]
colnames(res) <- c("PC1", "PC2")

plot.PCA(result, axes=c(1, 2), choix="ind", habillage="13")

dim <- dimdesc(result, axes=c(1,2))

dim1 <- data.frame(dim$Dim.1$quanti)
dim2 <- data.frame(dim$Dim.2$quanti)

htmlTable(round(res, 3),
          cgroup = c("2001-2015"),
          n.cgroup = c(2),
          caption = "IPNW PCA damage cause variable loadings",
          align = "c",
...
htmlTable(round(dim1, 5),
          cgroup = c("PC1"),
          n.cgroup = c(2),
          caption = "IPNW damage cause correlations and p-values",
          align = "c",
          rnames = rownames(dim1),
          css.cell = "padding-left: .5em; padding-right: .5em;")

htmlTable(round(dim2, 4),
          cgroup = c("PC2"),
          n.cgroup = c(2),
          caption = "IPNW damage cause correlations and p-values",
          align = "c",
          rnames = rownames(dim2),
          css.cell = "padding-left: .5em; padding-right: .5em;")
